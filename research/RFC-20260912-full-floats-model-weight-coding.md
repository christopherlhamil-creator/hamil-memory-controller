...
The occupancy plan for compiling tokenizer, KV, and weights as one same-geometry object is `/home/christopherhamil/tot_hybrid/docs/BLUEPRINT-20260912-OWN-ENGINE-SAME-GEOMETRY.md`; this RFC cites that plan without rewriting it. The current cut has separate measured tokenizer, KV, attention, RoPE, and weight-tail seams, not a claim that the complete forward runtime is landed.
